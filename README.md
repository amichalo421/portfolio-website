...
- [x] Study the code base and identify both responsive units and where media queries were used.  Take notes on anything that confuses you or interesting things you find.  Share this information in your standup meeting with your group
	(Refer to main.css)
	1. em's seem to be used instead of rem's
	2. the media querie numbers are different than typical or expected. For example the desktop view max width started at 1600 and tablet was at 736. I'm not sure if these are arbitrary or industry standard. 
	3. 
